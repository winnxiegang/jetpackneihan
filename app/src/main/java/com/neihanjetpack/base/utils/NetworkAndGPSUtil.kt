...
object NetworkAndGPSUtil {
    ...
    val isNetworkConnected: Boolean
        get() {
            val manager =
                MyApplication.getInstance().getSystemService(Context.CONNECTIVITY_SERVICE) as ConnectivityManager?
    ...
    fun isOpenGPS(): Boolean {
        val locationManager =
            MyApplication.getInstance().getSystemService(Context.LOCATION_SERVICE) as LocationManager
