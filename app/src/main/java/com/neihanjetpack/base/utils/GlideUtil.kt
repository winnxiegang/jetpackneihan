...
import com.neihanjetpack.GlideApp
...
object GlideUtil {
    ...
    fun loadFile(
        ...
        //本地图片无需磁盘缓存
        request.diskCacheStrategy(DiskCacheStrategy.NONE).listener(listener).into(iv)
    }
    ...
    fun loadUrlOrPath(
        ...
        request.diskCacheStrategy(DiskCacheStrategy.ALL).listener(listener).into(iv)
    }
