...
import com.neihanjetpack.base.http.interceptor.PublicHeaderInterceptor
...
//            setCertificates(builder, MyApplication.getInstance().assets.open("release.crt"))
//        }
